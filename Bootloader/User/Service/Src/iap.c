...
static uint8_t RecvResponseKeepAlive(uint32_t msg_id, void* buffer);
static uint8_t RecvResponseNewFirmwareInfo(uint32_t msg_id, void* buffer);
static uint8_t RecvResponseTheNPacket(uint32_t msg_id, void* buffer);
static uint8_t RecvResponseNowUTCTime(uint32_t msg_id, void* buffer);
static uint8_t RecvRequestOldFirmwareInfo(uint32_t msg_id, void* buffer);

static uint8_t SendRequestKeepAlive(uint32_t msg_id, void* buffer);
static uint8_t SendRequestNewFirmwareInfo(uint32_t msg_id, void* buffer);
static uint8_t SendRequestTheNPacket(uint32_t msg_id, void* buffer);
static uint8_t SendReportNPacketOK(uint32_t msg_id, void* buffer);
static uint8_t SendRequestNowUTCTime(uint32_t msg_id, void* buffer);
static uint8_t SendResponseOldFirmwareInfo(uint32_t msg_id, void* buffer);
